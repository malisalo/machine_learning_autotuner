...
## Create test file
```{r}
df<- read.csv("C:\\Users\\malisa\\Downloads\\all_years_leafs_final.csv")
...
write.csv(df, "C:\\Users\\malisa\\Downloads\\user_input_test.csv", row.names = FALSE)
```
...
user_data<- perform_imputation(user_imputation, user_data)

# create_rf(user_clean, user_predicting, user_split)
create_knn(user_data, user_predicting, user_split)
create_svm(user_data, user_predicting, user_split)
create_gbm(user_data, user_predicting, user_split)
```
